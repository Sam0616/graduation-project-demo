...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">查看 / 编辑</div>
            ...
            <form class="layui-form" method="post"
                ...
                <div class="layui-form-item" >
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="articleType" lay-verify="required" autocomplete="off" value="${article.articleType}"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline" style="width:793px;height: auto">
                            ...
                            <textarea class="layui-textarea" id="LAY_demo1" name="content"
