    ...
    layui.config({
        ...
        var tableIns = table.render({
            ...
            , cols: [[
                ...
                , {field: 'name', title: '宠物类别', width: 980, edit: 'text'}
                , {fixed: 'right', title: '操作', toolbar: '#test-table-toolbar-barDemo'}
            ]]
            , page: true
            , limit: 8
            , limits: [2, 3, 4, 5, 6, 7, 8,15,20]
        });
                ...
                case 'getCheckData':
                    ...
                    if (ids.length == 0) {
                        ...
                        layer.alert('确认删除这' + data.length + '条数据吗？', function (index) {
                            layer.close(index)
                            $.post("/category/delBatches", {ids}, function (res) {
        ...
        table.on('tool(test-table-toolbar)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                layer.open({
                    ...
                    content: "/category/toUpd?id=" + data.id
                });
        ...
        $('#queryRole').on('click', function (event, n) {
            ...
            if (n) {
                tableIns.reload({
                    url: '${pageContext.request.contextPath}/category/list?content=' + queryContent
                })
                return;
            }
            tableIns.reload({
