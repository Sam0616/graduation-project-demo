...
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    ...
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav" style="font-size: 16px;color: black!important;">
            ...
            <li><a href="/stulogout" style="color: black">退出登录</a></li>
        </ul>
    ...
    <figure data-am-widget="figure" class="am am-figure am-figure-default">
        <div>
            ...
            <div class="layui-form-item">
                <label style="font-weight: bold;color: maroon">简历头像:</label><br>
                <img width="150px" height="150px" src="${pageContext.request.contextPath}/img/${resume.imgPath}"
                     style="max-width: 196px">
            </div>
            <br>
            <br>

            <label style="font-weight: bold;color: maroon">个人信息:</label><br>
            ...
            <br>
            <label style="font-weight: bold;color: maroon">学校信息:</label><br>
            ...
            <form action="#" enctype="multipart/form-data" method="post">
                ...
                <textarea class="form-control" rows="6" name="introduction" readonly>${resume.introduction}</textarea>
                <br>
                <br>

                <label style="font-weight: bold;color: maroon">工作经验:</label>
                <textarea class="form-control" rows="6" name="experience" readonly>${resume.experience}</textarea>
                <br>
                <br>

                <label style="font-weight: bold;color: maroon">实习经历:</label>
                <textarea class="form-control" rows="6" name="learn" readonly>${resume.learn}</textarea>
                <br>
                <br>

                <label style="font-weight: bold;color: maroon">获奖记录:</label>
                <textarea class="form-control" rows="6" name="prize" readonly>${resume.prize}</textarea>
                <br>
                <br>

                <label style="font-weight: bold;color: maroon">获奖证书:</label>
                <textarea class="form-control" rows="6" name="certificate" readonly>${resume.certificate}</textarea>
                <br>
                <br>

                <label style="font-weight: bold;color: maroon">特长爱好:</label>
                <textarea class="form-control" rows="6" name="hobby" readonly>${resume.hobby}</textarea>
                <br>
                <br>

                <label style="font-weight: bold;color: maroon">希望的工作方向:</label>
                <textarea class="form-control" rows="6" name="hope" readonly>${resume.hope}</textarea>
                <br>
                <br>


                <div>
                    <label  style="font-weight: bold;color: maroon">附件下载:</label>
                    <button type="button" class="btn btn-primary" id="gain_resume">下载简历</button>
                </div>


                <br><br>

                <input type="submit" class="btn btn-primary btn-lg" id="from_submit" style="width: 100%" title="提交" disabled>
...
<script>
   $("#gain_resume").click(function () {
       location.href="/qiantai/resumeDownLoad"
   })
