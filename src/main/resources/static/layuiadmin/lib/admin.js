            ...
            v: "1.4.0 std", req: l.req, exit: l.exit, escape: function (e) {
                ...
                e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), n.on("click", function () {
                    ...
                    if (i === e.seconds && !a(this).hasClass(f)) {
                        ...
                        //改源码
                        if (n != null && n != "") {
                            $.post('/isRegistered', {phone: n}, function (res) {
                                if (res.data == "true") {//手机号不存在，可以注册
                                    // function getCode() {
                                        flag2 = 1 //把过期置成0的flag2置成1
                                    ...
                                    P.req(a.extend(!0, {
                                        url: "/auth/code", type: "get", data: {phone: n}, success: function (a) {
                                            layer.msg("验证码已发送至你的手机，请注意查收"), e.elemVercode.focus(), l(), s && s(a)
                                        }
                                    }, e.ajax))
                                } else {//手机号已经被注册！
                                    layer.msg("该手机号已经被注册！", {time: 2000, shift: 6, icon: 5})
                                }
                            })
                        }
                    }
